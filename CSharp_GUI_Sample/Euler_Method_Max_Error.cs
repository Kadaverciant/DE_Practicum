...
{
    class Euler_Method_Max_Error : Grid
    {
        public Euler_Method_Max_Error(double x0, double x1, double y0, int n, int n_max) : base(n, n_max, n_max - n)
        {
